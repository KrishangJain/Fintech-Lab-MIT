...
@Entity
@Table(name = "CUST_DTL_BACKUP")
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class CustomerDetailsBackup implements Serializable {
	...
	@Override
	public CustomerDetailsBackup clone()  {
		CustomerDetailsBackup customerDetails=new CustomerDetailsBackup();
